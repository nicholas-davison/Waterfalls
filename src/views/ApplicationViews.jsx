    ...
    return (
        <Routes>
            <Route path="/" element={
                ...
                <Route path="/favorites" element={<FavoriteFalls currentUser={currentUser} allWaterfalls={allWaterfalls} getRegionNameById={getRegionNameById} authoredWaterfalls={false} allLocations={allLocations}/>}/>
